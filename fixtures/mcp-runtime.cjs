  ...
  rl.on("line", async (line) => {
    ...
    try {
      ...
      if (message.method === "initialize") {
        result = { protocolVersion: message.params?.protocolVersion || "2025-06-18", capabilities: { tools: {} }, serverInfo: { name: "fixture-mcp", version: "0.1.0" } };
        ...
        result = await tool.run(message.params?.arguments || {});
